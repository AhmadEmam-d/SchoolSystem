...
export function AddLesson() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        // فلتر المواد اللي المدرس ده موجود في الـ teachers بتاعتها
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!created.success) {
        alert("فشل إنشاء الدرس: " + (created.errors?.[0] || "خطأ غير معروف"));
        return;
      }
      ...
      if (uploadedMaterials.length > 0) {
        await fetch(`${API_BASE_URL}/Lessons/${lessonId}`, {
          ...
          body: JSON.stringify({ materials: uploadedMaterials }),
        });
      }
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button type="button" variant="outline" size="sm" onClick={addObjective}>+ Add</Button>
            </div>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button type="button" variant="outline" size="sm" onClick={addLink}>+ Add</Button>
            </div>
          </CardHeader>
          <CardContent className="space-y-2">
            {links.map((link, i) => (
        ...
        <Card>
          ...
          <CardContent>
            <Textarea name="notes" placeholder="Private notes..." onChange={handleChange} />
          </CardContent>
        </Card>
