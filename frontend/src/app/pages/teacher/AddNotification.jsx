...
// Teacher can only notify Students or Parents (not Admin/Teacher/All)
const ROLE_OPTIONS = ['Student', 'Parent'];

export function AddNotificationTeacher() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Teacher uses the same notifications.send endpoint as Admin.
      // If your backend enforces role-based permissions server-side,
      // make sure "Teacher" is allowed to POST to this endpoint.
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Send a notification to your students or their parents
          </p>
        </div>
      </div>
