...
export function ExamGrades() {
  ...
  const handleExportReport = () => {
    ...
    csvData.push(`"Total Marks","${exam.totalMarks}"`);
    ...
    grades.forEach((student) => {
      ...
      csvData.push(`"${student.rank}","${student.studentId}","${student.studentName}","${student.grade}/${exam.totalMarks}","${letterGrade}","${performance}"`);
    });
    ...
    link.setAttribute('download', `exam_grades_${exam.class}_${new Date().toISOString().split('T')[0]}.csv`);
