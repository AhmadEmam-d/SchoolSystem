          ...
          <Card className="border-none shadow-md">
            ...
            <CardContent className="space-y-6">
              {[
                ...
                { key: 'homeworkReminders', label: t('homeworkReminders'), desc: t('homeworkRemindersTeacherDesc') },
                { key: 'gradeUpdates', label: t('gradeUpdatesLabel'), desc: t('gradeUpdatesTeacherDesc') },
              ].map(({ key, label, desc }) => (
