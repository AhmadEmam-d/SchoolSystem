...
import { STUDENTS, TEACHERS, RECENT_ACTIVITY } from '../../lib/mockData';
...
export function AdminDashboard() {
  ...
  const stats = [
    { label: t('totalStudents'), value: STUDENTS.length, icon: Users, color: 'text-blue-600', bg: 'bg-blue-100 dark:bg-blue-900/30', link: '/admin/students' },
    { label: t('totalTeachers'), value: TEACHERS.length, icon: Briefcase, color: 'text-purple-600', bg: 'bg-purple-100 dark:bg-purple-900/30', link: '/admin/teachers' },
    { label: t('totalParents'), value: '350', icon: Users, color: 'text-green-600', bg: 'bg-green-100 dark:bg-green-900/30', link: '/admin/parents' },
    { label: t('revenue'), value: '$52,000', icon: DollarSign, color: 'text-yellow-600', bg: 'bg-yellow-100 dark:bg-yellow-900/30', link: '/admin/reports' },
  ];
          ...
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data} key="attendance-chart">
                  <defs key="defs">
